...
shinyUI(
    navbarPage("Shiny Application",
               ...
               tabPanel("Go back to my Github repository",
                        a("https://github.com/sakshij25/Developing-Data-Products-Week4-Course-Project"),
                        hr(),
                        h4("I hope you like the Shiny App"),
                        h4("The name of the repository is Developing-Data-Products-Week4-Course-Project")
               )
    )
)